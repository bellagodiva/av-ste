...
class AVHubertPretrainingTask(FairseqTask):
    ...
    def get_label_dir(self) -> str:
        if not self.cfg.label_dir:   # handles None and empty string
    ...
    def load_dataset(self, split: str, **kwargs) -> None:
        ...
        if self.fine_tuning:
            # Replicate the single target dictionary once per label stream so
            # that pad_list / eos_list / procs all have the right length.
            dictionaries = [self.target_dictionary] * n_labels
        else:
